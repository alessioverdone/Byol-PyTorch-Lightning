"""fine_tuning_evaluation_base_variant.ipynb"""
...
checkpoint_callback = ModelCheckpoint(monitor='val_acc', 
                                      ...
                                      filename='Fine_tuning_variant_weight_'+ params.NAME_DATASET + '_'+'-{val_acc:.2f}-{epoch:02d}', 
...
# wandb.login()
# wandb.init()
# wandb_logger = WandbLogger(project='BYOL_fine_tuning_variant', log_model=True)
