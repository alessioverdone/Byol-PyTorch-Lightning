"""fine_tuning_evaluation_multiple_loss_variant.ipynb"""
...
class Fine_tuning(pl.LightningModule):
    ...
    def __init__(self, PATH, input_net, params):
        super(Fine_tuning, self).__init__()
...
checkpoint_callback = ModelCheckpoint(monitor='val_acc', 
                                      ...
                                      filename='Fine_tuning_multiple_loss_variant_weight_'+ params.NAME_DATASET + '_'+'-{val_acc:.2f}-{epoch:02d}', 
...
#Model
model = Fine_tuning(params.PATH_BYOL_WEIGHT, resnet, params)

##Logger
# wandb.login()
# wandb.init()
# wandb_logger = WandbLogger(project='BYOL_fine_tuning_multiple_loss_variant', log_model=True)
