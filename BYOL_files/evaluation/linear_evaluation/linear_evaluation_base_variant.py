"""linear_evaluation_base_variant.ipynb"""
...
class NetWrapper(nn.Module):
    def __init__(self, net, projection_size, projection_hidden_size, layer_name_list=['avgpool']):
        super().__init__()
        self.net = net
        self.layer_name_list = layer_name_list
        self.number_heads = len(layer_name_list)
    ...
    def forward(self, x):
        ...
        main_representation = representation[-1]
...
class Linear_Classifier(pl.LightningModule):
    ...
    def __init__(self, PATH, input_net, params):
        ...
        self.classifier = nn.Linear(self.params.DIM_REPR + self.params.DIM_REPR1 + self.params.DIM_REPR2, self.params.NUMBER_OF_CLASSES)
    ...
    def forward(self, x):
        ...
        final_out = torch.cat([out[-1],out[-2], out[-3]], dim=-1)
...
class hparams():
    ...
    DIM_REPR1 = 1024 #resnet18 layer3.0 dimension for 32x32 img
    DIM_REPR2 = 2048 #resnet18 layer2.0 dimension for 32x32 img
    
    # DIM_REPR = 512   #resnet18 avgpool dimension
    # DIM_REPR1 = 50176 #resnet18 layer3.0 dimension for 224x224 img
    # DIM_REPR2 = 100352 #resnet18 layer2.0 dimension for 224x224 img
    
    # DIM_REPR = 2048  #resnet50 avgpool dimension
    # DIM_REPR1 = 200704 #resnet50 layer3.0 dimension for 224x224 img
    # DIM_REPR2 = 401408 #resnet50 layer2.0 dimension for 224x224 img
...
checkpoint_callback = ModelCheckpoint(monitor='val_acc', 
                                      ...
                                      filename='Linear_evaluation_base_variant_weight_'+ params.NAME_DATASET + '_'+'-{val_acc:.2f}-{epoch:02d}', 
...
#Model
model = Linear_Classifier(params.PATH_BYOL_WEIGHT,
                          resnet,
                          params)
...
# wandb.login()
# wandb.init()
# wandb_logger = WandbLogger(project='BYOL_linear_evaluation_base_variant', log_model=True)
