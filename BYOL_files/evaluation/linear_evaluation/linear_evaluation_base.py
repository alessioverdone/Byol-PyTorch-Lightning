...
checkpoint_callback = ModelCheckpoint(monitor='val_acc', 
                                      ...
                                      filename='Linear_evaluation_base_weight_'+ params.NAME_DATASET + '_'+'-{val_acc:.2f}-{epoch:02d}', 
...
# wandb.login()
# wandb.init()
# wandb_logger = WandbLogger(project='BYOL_linear_evaluation_base', log_model=True)
